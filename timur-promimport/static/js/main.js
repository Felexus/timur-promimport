...
$(document).ready(function () {
	...
	if($("#fullpage").length) {
		...
		$('#fullpage').fullpage({
			...
			navigation: true,
			navigationTooltips: ['rak', 'prod', 'usl', 'best', 'work', 'ser', 'otz', 'part', 'cont', 'footer'],
			anchors: ['rak', 'prod', 'usl', 'best', 'work', 'ser', 'otz', 'part', 'cont', 'footer'], 
			menu: '#myMenu',
	...
	$(".field-item").each(function() {
		...
		$(this).append("<div class='field-item-title'>"+placeholder+"</div>")
	});
	...
	$(".field-item input").focusout(function() {
		$(this).removeClass("active");
		$(".field-item input").each(function() {
			if ($(this).val().length > 0) {
				$(this).addClass("active");
	...
	var swiper1 = new Swiper('.work-swiper', {
		navigation: {
	  ...
	  var swiper2 = new Swiper('.otz-container-swiper', {
		navigation: {
		  nextEl: '.swiper-button-next',
		  prevEl: '.swiper-button-prev',
		},
	...
	$('.cont-container-form').each(function() {
        var it = $(this);
         it.validate({
			rules: {
				name: {
